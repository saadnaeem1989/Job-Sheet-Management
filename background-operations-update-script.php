...
$query  = "UPDATE jobsheets SET week='$week', date='$date', purchaseorderno='$purchaseorderno', timeonsite='$timeonsite', breakstart='$breakstart', breakfinish='$breakfinish', driverhours='$driverhours',";
...
//header("location:operations-jobsheets.php");

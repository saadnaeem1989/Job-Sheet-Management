...
<title>Admim Jobsheet View</title>
...
<div  style="display: block;">
  ...
  <input type="hidden" name="csvtrucks" value="<?php echo $match?>"
 <span class="glyphicon glyphicon-list-alt"></span>
  <button type="submit" class="btn btn-block btn-default" type="submit"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Export CSV</button> </form>
  
  
 <form action="jobsheets.php" method="post">

				

  
  <button type="submit" class='btn btn-block btn-success' type="submit"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</button>
  </form> 

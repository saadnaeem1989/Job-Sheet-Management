...
$query  = "SELECT managername FROM managers where id='$id'";
...
?>
   ...
   <form  action="background-edit-manager.php" method="get">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" value="<?php echo $row['managername'];?>" name="managername" required>
      </div>
    </div>
 ...
 <span class="glyphicon glyphicon-list-alt"></span> Update Manager Record
</button>
 </div>

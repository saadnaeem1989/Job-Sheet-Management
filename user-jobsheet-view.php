...
<div class="row" id="getthere">
  ...
  <div class="col-sm-4"><h3>Entered Job Sheet Data</h3></div>
...
<div  style="display: block;">
    	...
    	<h2 class='text-center'>Trucks Washed</h2>
			...
			<form action="user-jobsheet-interface.php" method="post">

				
  <div> <button type="submit" class='btn btn-large btn-block btn-success' type="submit">Back to View Jobsheets</button></div>
  </form>  
		</div>
	</div></div>

...
<?php include 'operations/header.php';?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form action="background-operations-update-script.php" method="post"  class="form-horizontal" role="form" data-parsley-validate novalidate>
...
$id=$row2['id'];
 ...
 <input type="hidden" name="<?php echo "jobSheetTruckId$i"?>" value="<?php echo $row2['id']?>">
  ...
  <a href="operations-jobsheets.php" class="btn btn-block btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Back to Job Sheets</a>
</div>
